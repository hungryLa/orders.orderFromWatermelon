...
XAAAoRAuAIBQ/gSIww4ZVui7KAAAAABJRU5ErkJggg=="/>
    ...
    <div>1.1. Продавец передает в собственность, а Покупатель принимает и оплачивает: {{$furnitures}}</div>
    ...
    <div>
        ...
        Договора в срок <div class="for_input_with_underline">{{\Carbon\Carbon::parse($order->deadline_delivery)->format('d.m.Y') ?: 0}}</div>. Качество Мебели должно соответствовать ГОСТ 16371-93 «Мебель -общие технические

...
XAAAoRAuAIBQ/gSIww4ZVui7KAAAAABJRU5ErkJggg=="/>
    ...
    <div>
        ...
        Договора в срок ________________________. Качество Мебели должно соответствовать ГОСТ 16371-93 «Мебель -общие технические
    ...
    <div>
        3.1. Цена Договора включает в себя стоимость всей Мебели, передаваемой по настоящему Договору, и составляет {{$order->price}} рублей,
        ...
        -3.3.1. Покупатель вносит авансовый платеж в размере {{$order->deposit ?: 0}} рублей, в том числе НДС не облагается
